  ...
  surveys: [
    {
      surveyNumber: 1,
      contents: [
        { title: "포토 카드", selectedCount: 400, ratio: 31 },
    ...
    },
    {
      surveyNumber: 2,
      contents: [
        { title: "콘서트", selectedCount: 520, ratio: 42.2 },
        { title: "팬미팅", selectedCount: 380, ratio: 30.3 },
        { title: "사인회", selectedCount: 290, ratio: 23.2 },
        { title: "팬티켓팅", selectedCount: 180, ratio: 14.4 },
        { title: "음악방송", selectedCount: 150, ratio: 12.5 },
      ],
    },
    {
      surveyNumber: 3,
